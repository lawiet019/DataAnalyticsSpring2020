...
#Our goal is to identify the 3 variates based on
#the chemical data on the wine dataset.
#In order to make it easy identify the 3
#cultivars, we will declare 3 classes that
#represents each cultivar (Cv1,Cv2,Cv3) by
#using the factor() function in R
#Read the documentation in Rstudio for the
#factor() function.
# declaring the cultivar_classes using the
#factor() function each cultivar Cv1,Cv2 and
#Cv3.
